...
void JTypes_Testing::testLimits(int& tc, int& fc) {
  ...
  int32 min_int32 = JINT32_MIN;
  int32 max_int32 = JINT32_MAX;
  displaySuccess("int32 INT32_MIN representation", (min_int32 == JINT32_MIN), tc, fc);
  displaySuccess("int32 INT32_MAX representation", (max_int32 == JINT32_MAX), tc, fc);
  displaySuccess("int32 increment wrapping", (++max_int32 == JINT32_MIN), tc, fc);
  displaySuccess("int32 decrement wrapping", (--min_int32 == JINT32_MAX), tc, fc);

  int64 min_int64 = JINT64_MIN;
  int64 max_int64 = JINT64_MAX;
  displaySuccess("int64 INT64_MIN representation", (min_int64 == JINT64_MIN), tc, fc);
  displaySuccess("int64 INT64_MAX representation", (max_int64 == JINT64_MAX), tc, fc);
  displaySuccess("int64 increment wrapping", (++max_int64 == JINT64_MIN), tc, fc);
  displaySuccess("int64 decrement wrapping", (--min_int64 == JINT64_MAX), tc, fc);
