...
const int32 JINT32_MIN = std::numeric_limits<int32>::min();
const int32 JINT32_MAX = std::numeric_limits<int32>::max();
  
const int64 JINT64_MIN = std::numeric_limits<int64>::min();
const int64 JINT64_MAX = std::numeric_limits<int64>::max();
